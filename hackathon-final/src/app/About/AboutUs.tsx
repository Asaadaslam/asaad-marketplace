...
export default function Aboutus() {
  return (
    <div>
      ...
      {/* Second Section */}
      <section className="text-white body-font">
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col w-[1100px]">
          ...
          <Image
            className="mb-10 object-cover object-center w-1520px h-360px mt-1552px ml-300px mt-10"
            alt="hero"
            src = "/aboutChooseUs.png"
