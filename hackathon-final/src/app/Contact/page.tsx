...
export default function () {
    ...
    return (
        <div className="mt-32 mb-32 grid md:grid-cols-3 items-start gap-4 max-md:gap-12 max-w-6xl mx-auto py-6 bg-white font-[sans-serif]">
      <div className="px-4">
      ...
      <div className="bg-gray-800 rounded-3xl md:col-span-2 p-8">
        <h2 className="text-2xl text-coffee font-semibold">Product or Service Inquiry</h2>
        ...
        <form>
          <div className="space-y-4 mt-8">
            <input type="text" placeholder="Full Name"
              className="px-2 py-3 bg-transparent text-gray-200 font-medium w-full text-sm border-b border-gray-400 focus:border-coffee outline-none" />
            ...
            <textarea placeholder="Write Message"
              className="px-2 pt-3 bg-transparent text-gray-200 font-medium w-full text-sm border-b border-gray-400 focus:border-coffee outline-none"></textarea>
          </div>

          <button type="button"
            className="mt-8 flex items-center justify-center text-sm w-full rounded-md px-4 py-2.5 text-gray-800 bg-coffee hover:bg-yellow-500">
            <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor' className="mr-3"
